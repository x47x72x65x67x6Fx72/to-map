...
//      a:[... place1, place2 ...], b:[... boss1, boss2, ...], m:[... mob1, mob2, ...]}} ...]), 
//  edges: const edges = new vis.DataSet([... {from: id_1, to: id_2}, ...])
// };
//
// Currently last Id is: 140 with missing ids: 0 and 24 (Removed)
//
...
const nodes = new vis.DataSet([
    ...
    {"id":62, "x":14, "y":11, "label":"Spring of Rebirth", "d": { // TODO: CHECK IF OVERLAPP / FIX ID!
    ...
    {"id":104, "x":6, "y":4, "label":"Nov Saterica", "d": {
        "a":["Nov Saterica"], 
        "b":[], 
